...
from _paths import practice_path
...
def discrete_atk(arg_N=2):
    ...
    with open(practice_path("parameters.yml")) as f:
    ...
    for i_t, t in enumerate(loads):
        ...
        logging.critical(f"u_t norm {np.linalg.norm(state['u'].x.array)}")
...
def postprocess(history_data, prefix, nameExp):
    ...
    from irrevolutions.utils.plots import plot_force_displacement
