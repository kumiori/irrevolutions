...
def traction_with_parameters(parameters, slug = ''):
    ...
    # for i_t, t in enumerate([0., .99, 1.0, 1.01]):
        ...
        history_data["solver_AM_data"].append(hybrid.data)
        ...
        _timings = timings(MPI.COMM_WORLD, [dolfinx.common.TimingType.wall])
...
if __name__ == "__main__":
    ...
    for ell in [0.1, 0.2, 0.3]:
        ...
        history_data, timings =  traction_with_parameters(parameters)
