...
for current_time_step in range(num_time_steps):
    ...
    for mode in range(1, num_modes + 1):
        ...
        mode_shapes_data['point_values'][mode_key] = {
            'field_1': mode_shapes_data['point_values'].get(mode_key, {}).get('field_1', []),
            'field_2': mode_shapes_data['point_values'].get(mode_key, {}).get('field_2', []),
        }
        mode_shapes_data['point_values'][mode_key]['field_1'].append(field_1_values_mode)
