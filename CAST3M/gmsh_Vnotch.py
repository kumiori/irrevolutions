...
order = 1,
    ...
    c0 = initial crack size for LEFM analysis
    key = 0 -> create model for Fenicxs (default)
          1 -> create model for Cast3M
    c0 = initial crack size for LEFM analysis (for key = 1)
    n = width of the load interface for FENICXS (key = 0)
...
a=0.00178
c0 = (h-a)*0.001
mesh_V(a,h, L, gamma, h/25, h/125, key=0, c0 = c0, show = True)
